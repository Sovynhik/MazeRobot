...
public class MazeModel {
    ...
    private final Point robotStart, treasure;
    ...
    public MazeModel(int width, int height) {
        ...
        initializeGrid();
        robotStart = new Point(1, 1);
        treasure = new Point(width - 2, height - 2);
        grid[treasure.y()][treasure.x()] = CellType.TREASURE;
    }
    ...
    public Point getRobotStart() { return robotStart; }
    public Point getTreasure() { return treasure; }
}